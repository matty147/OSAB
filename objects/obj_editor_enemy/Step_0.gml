...
var before_cur_time = (-timeline.timeline_offset < object_time + round(sprite_width / timeline.line_amount_w));
var after_cur_time = -timeline.timeline_offset + 1 > object_time;

display_object = visible || (before_cur_time && after_cur_time);

visible = place_meeting(x,y,obj_timeline);

if (instance_exists(obj_display_object))
{
	obj_display_object.visible = display_object;
}
