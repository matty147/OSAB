...
//draw_line(start_point,y,end_point,y);
	...
	if !dragging
	{
		if x > instance.x && room_width > x
		{
			...
			draw_sprite_ext(asset_get_index(string(display_image)),0,object_x,object_y,object_x_scale,object_y_scale,0,c_white,1);
			...
			draw_line(real(object_x),real(object_y),end_x, end_y);
		}
	}
