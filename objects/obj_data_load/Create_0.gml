...
if (global.load_save)
{
    ...
    if (file_exists(working_directory + "save.sosab"))
    {
		...
		if (
		    ds_exists(data,ds_type_map) &&
		    ds_map_exists(data, "volume") &&
		    ds_map_exists(data, "story_progress") &&
		    ds_map_exists(data, "fullscreen")
			)        
		{
		...
		{
		    show_debug_message("invalid save data – regenerating");
		    scr_save_data();
		}
